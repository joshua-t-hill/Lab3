...
public static class Constants
{
    ...
    public const string SQLCreateAirportTableNotExistsString = "CREATE TABLE IF NOT EXISTS airports (id CHAR(4) PRIMARY KEY, city VARCHAR(25), date_visited TIMESTAMP, rating SMALLINT)";
